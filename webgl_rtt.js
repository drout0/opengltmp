...
<html lang="en">
	...
	<body>
		...
		<script type="module">
			...
			var rtTexture, plane_material, quad;
			...
			function init() {
				...
				quad = new THREE.Mesh( plane, plane_material );
				quad.position.z = - 100;
				sceneRTT.add( quad );
			...
			function render() {
				...
				if ( plane_material.uniforms[ "time" ].value > 1 || plane_material.uniforms[ "time" ].value < 0 ) {

					delta *= - 1;

				}

				plane_material.uniforms[ "time" ].value += delta;
